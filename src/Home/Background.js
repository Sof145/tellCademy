            ...
            <div id="bg-wrap" className='h-full max-h-full'>
                <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice">
                    <defs>
                        ...
                        <radialGradient id="Gradient6" cx="50%" cy="50%" fx="0.981338%" fy="50%" r=".5"><animate attributeName="fx" dur="25.5s" values="0%;5%;0%" repeatCount="indefinite"></animate><stop offset="0%" stop-color="rgba(253, 157, 194, 1)"></stop><stop offset="100%" stop-color="rgba(253, 157, 194, 0)"></stop></radialGradient>
                    </defs>
